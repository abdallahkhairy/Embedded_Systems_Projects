...
# 13 "./AECUL_Modules/RealTimeClockDS1307/RealTimeClockDS1307.h"
...
# 22 "./AECUL_Modules/EEPROM_24C02C/EEPROM_24C02C.h"
...
# 78 "main.c"
    ...
    U4RValue = EEPROM_24C02C_Read_Byte(0xA2, 0x08);
    U5RValue = EEPROM_24C02C_Read_Byte(0xA6 , 0x08);
    while (1)
    {

        RealTimeClockDS1307 = RealTimeClockDS1307_Get_Date_time();
        Print_RealTimeClockDS1307();
        temp_value = TempSensor_TC74_Read_Temp(0x9E);
