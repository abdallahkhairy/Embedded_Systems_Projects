...
int main() {
    ...
    while(1){
        ...
        if((0 && isdigit(keypad_value), ((unsigned)(keypad_value)-'0') < 10) && !num2_flag){
        ...
        else if((0 && isdigit(keypad_value), ((unsigned)(keypad_value)-'0') < 10) && num2_flag){
