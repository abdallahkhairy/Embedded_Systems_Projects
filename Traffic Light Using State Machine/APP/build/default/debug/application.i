...
Std_ReturnType lcd_8bit_clear(const chr_lcd_8bit_t *lcd);
...
# 14 "./ECU_Layer/RealTimeClockDS1307/RealTimeClockDS1307.h"
...
extern led_t led_yellow_car;
extern led_t led_yellow_people;
...
typedef enum{
    CARS_MOVE_PEDESTRIANS_STOP_STATE = 0,
    CARS_READY_TO_STOP_PEDESTRIANS_STOP_STATE,
    PEDESTRIAN_MOVE_CARS_STOP_STATE,
    PEDESTRIANS_READY_TO_STOP_CARS_STOP_STATE
}traffic_light_state_t;


typedef enum{
    TIME_OF_CARS_MOVE_FINISHED_EVENT = 0,
    READY_TIME_OF_CARS_TO_STOP_FINISHED_EVENT,
    TIME_OF_PEDESTRAINS_MOVE_FINISHED_EVENT,
    READY_TIME_OF_PEDESTRIANS_TO_STOP_FINISHED_EVENT
...
traffic_light_state_t ReadyTimeOfCarsToStopFinishedHandler(void);
traffic_light_state_t ReadyTimeOfPedestriansToStopFinishedHandler(void);
...
int main() {
  ...
  traffic_light_state = ReadyTimeOfPedestriansToStopFinishedHandler();
  traffic_light_event = READY_TIME_OF_PEDESTRIANS_TO_STOP_FINISHED_EVENT;
  while (1) {
    ret = seven_segement_write_number(&seg1, seven_seg_cnt / 10);
    ret = seven_segement_write_number(&seg2, seven_seg_cnt % 10);
    switch(traffic_light_state){
        case CARS_MOVE_PEDESTRIANS_STOP_STATE:
            if(TIME_OF_CARS_MOVE_FINISHED_EVENT == traffic_light_event){
                traffic_light_state = TimeOfCarsMoveFinishedHandler();
            }
        break;
        case CARS_READY_TO_STOP_PEDESTRIANS_STOP_STATE:
            if(READY_TIME_OF_CARS_TO_STOP_FINISHED_EVENT == traffic_light_event){
                traffic_light_state = ReadyTimeOfCarsToStopFinishedHandler();
            }
        break;
        case PEDESTRIAN_MOVE_CARS_STOP_STATE:
            if(TIME_OF_PEDESTRAINS_MOVE_FINISHED_EVENT == traffic_light_event){
                traffic_light_state = TimeOfPedestriansMoveFinishedHandler();
            }
        break;
        case PEDESTRIANS_READY_TO_STOP_CARS_STOP_STATE:
            if(READY_TIME_OF_PEDESTRIANS_TO_STOP_FINISHED_EVENT == traffic_light_event){
                traffic_light_state = ReadyTimeOfPedestriansToStopFinishedHandler();
            }
        break;
        default:
  ...
  if(0 == seven_seg_cnt){
    switch(traffic_light_event){
          case TIME_OF_CARS_MOVE_FINISHED_EVENT:
            seven_seg_cnt = 20;
            next_traffic_light_event = READY_TIME_OF_CARS_TO_STOP_FINISHED_EVENT;
          break;
          case READY_TIME_OF_CARS_TO_STOP_FINISHED_EVENT:
            seven_seg_cnt = 5;
            next_traffic_light_event = TIME_OF_PEDESTRAINS_MOVE_FINISHED_EVENT;
          break;
          case TIME_OF_PEDESTRAINS_MOVE_FINISHED_EVENT:
            seven_seg_cnt = 20;
            next_traffic_light_event = READY_TIME_OF_PEDESTRIANS_TO_STOP_FINISHED_EVENT;
          break;
          case READY_TIME_OF_PEDESTRIANS_TO_STOP_FINISHED_EVENT:
            seven_seg_cnt = 5;
...
void Int0_APP_ISR(void) {
    if(traffic_light_state != CARS_READY_TO_STOP_PEDESTRIANS_STOP_STATE){
        ret = led_turn_off(&led_green_car);
        ret = led_turn_off(&led_red_people);
        ret = led_turn_off(&led_yellow_people);
        seven_seg_cnt = 20;
        ret = lcd_4bit_clear(&lcd_1);
        traffic_light_state = CARS_READY_TO_STOP_PEDESTRIANS_STOP_STATE;
        traffic_light_event = READY_TIME_OF_CARS_TO_STOP_FINISHED_EVENT;
...
traffic_light_state_t TimeOfCarsMoveFinishedHandler(void){
    ...
    ret = lcd_4bit_send_string_pos(&lcd_1, 4, 1,"To MOVE =>=>");

    return CARS_READY_TO_STOP_PEDESTRIANS_STOP_STATE;
}
traffic_light_state_t ReadyTimeOfCarsToStopFinishedHandler(void){
    ...
    return PEDESTRIAN_MOVE_CARS_STOP_STATE;
}
traffic_light_state_t TimeOfPedestriansMoveFinishedHandler(void){
    ...
    return PEDESTRIANS_READY_TO_STOP_CARS_STOP_STATE;
}
...
traffic_light_state_t ReadyTimeOfPedestriansToStopFinishedHandler(void){
    ...
    return CARS_MOVE_PEDESTRIANS_STOP_STATE;
}
