...
# 3 "ECU_Layer/ecu_layer_init.c" 2
...
# 4 "ECU_Layer/ecu_layer_init.c" 2
...
# 105 "ECU_Layer/ecu_layer_init.c"
...
led_t led_red_car = {._led.port = PORTD_INDEX, ._led.pin = GPIO_PIN6, ._led.logic = LED_OFF};
led_t led_green_car = {._led.port = PORTD_INDEX, ._led.pin = GPIO_PIN7, ._led.logic = LED_OFF};

led_t led_red_people = {._led.port = PORTA_INDEX, ._led.pin = GPIO_PIN0, ._led.logic = LED_OFF};
led_t led_green_people = {._led.port = PORTA_INDEX, ._led.pin = GPIO_PIN1, ._led.logic = LED_OFF};

led_t led_yellow_car = {._led.port = PORTA_INDEX, ._led.pin = GPIO_PIN2, ._led.logic = LED_OFF};
led_t led_yellow_people = {._led.port = PORTA_INDEX, ._led.pin = GPIO_PIN3, ._led.logic = LED_OFF};
...
void ecu_layer_init(void){
    ...
    ret = led_initialize(&led_yellow_car);
    ret = led_initialize(&led_yellow_people);
