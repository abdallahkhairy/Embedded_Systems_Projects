...
# 351 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_string_pos(const chr_lcd_8bit_t *lcd, uint8 row, uint8 column, uint8 *str){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == lcd){
        ret = (Std_ReturnType)0x00;
...
# 374 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_custom_char(const chr_lcd_8bit_t *lcd, uint8 row, uint8 column,
                                         const uint8 _chr[], uint8 mem_pos){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 lcd_counter = 0;
...
# 412 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType convert_uint8_to_string(uint8 value, uint8 *str){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == str){
        ret = (Std_ReturnType)0x00;
...
# 432 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType convert_uint16_to_string(uint16 value, uint8 *str){
    Std_ReturnType ret = (Std_ReturnType)0x01;
...
# 459 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType convert_uint32_to_string(uint32 value, uint8 *str){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == str){
        ret = (Std_ReturnType)0x00;
...
# 495 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
static Std_ReturnType lcd_4bit_send_enable_signal(const chr_lcd_4bit_t *lcd){
    Std_ReturnType ret = (Std_ReturnType)0x01;
...
# 510 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
static Std_ReturnType lcd_8bit_send_enable_signal(const chr_lcd_8bit_t *lcd){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    ret = gpio_pin_write_logic(&(lcd->lcd_en), GPIO_HIGH);
    _delay((unsigned long)((5)*(8000000UL/4000000.0)));
...
# 549 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
static Std_ReturnType lcd_4bit_set_cursor(const chr_lcd_4bit_t *lcd, uint8 row, uint8 coulmn){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    coulmn--;
    switch(row){
